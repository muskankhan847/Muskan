...
DATABASE_NAME = environ.get('DATABASE_NAME', "inayatalibarkaat")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
VERIFY = bool(environ.get('VERIFY', False))
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'shareus.io')
SHORTLINK_API = environ.get('SHORTLINK_API', 'LftdVbw4mxeOaY3u8dWGFzorF663')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', True))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/allinoneadda0')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/backup7800')
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Enayatali1')
...
URL = "https://filteesr-bot.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://filteesr-bot.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://filteesr-bot.onrender.com/".format(FQDN)
else:
    URL = "https://filteesr-bot.onrender.com/".format(FQDN)
